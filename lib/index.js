...
class EnterpriseProbePlugin {
   ...
   */
  watcher (request) {
    const payload = request.input.body.payload;

    this.dsl.test(payload.data.index, payload.data.collection, payload.data.body, payload.data._id)
      .then(matchedIds => {
